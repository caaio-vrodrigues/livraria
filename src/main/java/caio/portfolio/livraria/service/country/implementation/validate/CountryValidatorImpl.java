...
public class CountryValidatorImpl implements CountryValidator {
	...
	public String processIsoAlpha2Code(String isoAlpha2Code) {
		boolean isIsoAlpha2CodeNullOrBlank = isoAlpha2Code == null || 
			isoAlpha2Code.isBlank();
		...
		boolean validIsoAlpha2Code = validIsoCodes
	...
	public String resolveNameByIsoAlpha2Code(String isoAlpha2Code) {
		return getNameByValidatedAndNormalizedIsoAlpha2Code(
			processIsoAlpha2Code(isoAlpha2Code));
	}

	@Override
	public String getNameByValidatedAndNormalizedIsoAlpha2Code(
